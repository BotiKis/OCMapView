...
- (void)doClustering{
    ...
    NSMutableArray *annotationsToCluster = [[NSMutableArray alloc] initWithArray:[allAnnotations allObjects]];
    [annotationsToCluster removeObjectsInArray:[annotationsToIgnore allObjects]];
    annotationsToCluster = [NSMutableArray  arrayWithArray:[self filterAnnotationsForVisibleMap:annotationsToCluster]];
