...
It is written in Objective-C with ARC and C and works in all iOS applications.

The sample project is generated with Xcode 4.2 and written for iOS 5.0 with ARC as the OCMapView class. In fact, OCMapView is backwards compatible (iOS 4.x) but you need to run your project on Xcode 4.2 and set the deployment target of your app to your desired iOS version.
