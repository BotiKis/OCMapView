//
//  OClusterMapViewSampleViewController.m
//  openClusterMapView
//
//  Created by Botond Kis on 14.07.11.
//

#import "OClusterMapViewSampleViewController.h"
#import "OCMapViewSampleHelpAnnotation.h"
#import <math.h>

#define ARC4RANDOM_MAX 0x100000000

@implementation OClusterMapViewSampleViewController
@synthesize mapView;
...
- (NSArray *)randomCoordinatesGenerator:(int) numberOfCoordinates{
    ...
    for (int i = 0; i < numberOfCoordinates; i++) {
        ...
        [coordinates addObject:[[CLLocation alloc]initWithLatitude:latitude longitude:longitude]];
    }
    return  coordinates;
}
